...
namespace DevFeatures.Dialogue
{
    ...
    public class DialogueManager : MonoBehaviour
    {
        ...
        public bool playedDialogueInScene;
        ...
        private void OnNextButtonPressed()
        {
            ...
            else if (_currentDialogue?.Next is 0 or null) Debug.LogError("why next Dialogue is null?");
        }
        ...
        private IEnumerator CoPlayLine(int dialogueID)
        {
            ...
            _currentDialogue = dialogueInfos.Find(dialogueID);
            if (_currentDialogue == default)
            {

...
namespace LiveLarson.UISystem.Editor
{
    public class UIWindowScriptMaker : EditorWindow
    {
        private const string BASE_DIRECTORY = "Assets/Scripts/UI";
        private const string DEFAULT_NAMESPACE_NAME = "UI";
        ...
        public static UIComponent CreateUIComponent(Component component)
        {
            return component switch
            {
                ...
                TMP_Dropdown ui => new UIComponent(UIWindow.UIComponent.Types.TMPDropdown, ui),
        ...
        private void BuildClass(GameObjectTree.Node node)
        {
            ...
            var targetDirectory = BASE_DIRECTORY;
        ...
        private void WriteFile(GameObjectTree.Node node, string path, bool isGenerated)
        {
            ...
            writer.WriteLine("");
            writer.WriteLine("namespace " + DEFAULT_NAMESPACE_NAME);
            writer.WriteLine("{");
        ...
        private void WriteComponentEnumAndProperty(StreamWriter writer, GameObjectTree.Node node, int indentLevel)
        {
            ...
            writer.WriteLine($"{indent}{{");
            foreach (var component in uiComponets.Where(component => component.enable))
        ...
        private void Attach()
        {
            const string baseName = DEFAULT_NAMESPACE_NAME + ".";
            var node = _gameObjectTree.Root;

...
namespace LiveLarson.UISystem
{
    public class UIWindowManager : MonoBehaviour, IUIWindowManager
    {
        ...
        private void InitContainer()
        {
            ...
            try
            {
                foreach (var uiKeyValue in uiContainer.uis)
                {
                    index++;
        ...
        private const int ADD_SORTING_ORDER = 10;
        ...
        private void GetSortingOrder(UIWindow window, int chileCanvasCount = 0, bool isKeepSortingOrder = false)
        {
            ...
            _lastSortingOrder += chileCanvasCount + ADD_SORTING_ORDER;
        ...
        public static void ReleaseSortingOrder(UIController body)
        {
            ...
            Instance._lastSortingOrder -= body.SubWindowCount + ADD_SORTING_ORDER;
        ...
        private const float INSTANTIATE_WAIT_TIME = 5f;
            ...
            WindowOption option = WindowOption.None) where T : UIWindow
        {
            ...
            {
                Debug.LogError("Failed to create window because Path is null or empty");
                yield break;
            }
            ...
            while (!windowCreate)
            {
                ...
                if (!(currentWaitTime > INSTANTIATE_WAIT_TIME))
                    continue;
                Debug.LogError("Open UIWindow very long delay [Type] : " + typeof(T) + "RequestTime : " +
